        ...
        <div className="flex items-center gap-3">
          ...
          <span className="truncate">
            {selectedSub ? getDisplayText(selectedSub) : 'Select a subscription'}
                ...
                {isOpen && (
                    <div
                        className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-100 overflow-auto">
                        {subscriptions.map((sub: Subscription) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-700 ${isSelected ? 'bg-gray-50 dark:bg-gray-700/50' : ''
                                    }`}
                                >
