...
export function Breadcrumbs() {
  ...
  if (currentPath.startsWith("/keyvault")) {
    ...
    const keyvaultMatch = matches.find((m) => m.pathname === "/keyvault");
    const searchParams = keyvaultMatch?.search as
      | {
          name?: string;
  ...
  return (
    <nav
      ...
      className="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400 py-2 px-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700"
    >
