...
import {fetchSecrets, fetchSecretsKey, createSecret, deleteSecret} from '../services/azureService'
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          {secrets.length > 0 && selectionMode && (
            <div
              className="flex items-center gap-3 mb-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
              <button
                type="button"
